...
firepad.Firepad = (function(global) {
  ...
  function Firepad(ref, place, options) {
    ...
    this.editor_.adapter = this.editorAdapter_
    this.firebaseAdapter_ = new FirebaseAdapter(ref, userId, userColor,this.editor_);
    ...
    this.firebaseAdapter_.on('initialRevisions',()=>{
      this.editor_.setValue('');
      this.editor_.adapter.initiated=true;
    })
